...
public class ClosestPoints {
	...
	private Pair divide(int left, int right) { // a = 2, b = 2, k = 1 O(nlogn)
		if (right - left > 3) {
		...
		return bruteForce(points.subList(left, right)); // we can't consider it quadratic because it's such a small
														// sample
	}
